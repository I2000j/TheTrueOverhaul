...
{
  public class BloodedSpore : ModItem
  {
    ...
    public override bool CanUseItem(Player player) => !TrueOverhaulWorld.MonstersRelocateUp && TrueOverhaul.modConfiguration.Relocating;
