...
{
  public class HallowedMenu : ModMenu
  {
    public override string DisplayName => "Hallow";

    public override int Music => 9;

    public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("TrueOverhaul/Assets/Textures/Menu/LogoHallow", (AssetRequestMode) 2);
