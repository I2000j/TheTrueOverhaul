...
{
  public class CorruptedMenu : ModMenu
  {
    public override string DisplayName => "Corruption";

    public override int Music => 8;

    public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("TrueOverhaul/Assets/Textures/Menu/LogoCorruption", (AssetRequestMode) 2);
