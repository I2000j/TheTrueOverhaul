...
{
  public class JungleedMenu : ModMenu
  {
    public override string DisplayName => "Jungle";

    public override int Music => 7;

    public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("TrueOverhaul/Assets/Textures/Menu/LogoJungle", (AssetRequestMode) 2);
